<template>
  ...
  <v-container>
    ...
    <v-dialog v-model="showDialog" scrollable width="840">
      <task-form :item="selectedItem" @form:success="handleFormSuccess" @form:cancel="handleFormCancel" />
    </v-dialog>
  </v-container>
...
import CAvatar from '@/demo-components/avatar/CAvatar'
import TaskForm from '@/demo-components/form/TaskForm'
