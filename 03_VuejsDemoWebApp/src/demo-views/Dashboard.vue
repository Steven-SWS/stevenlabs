...
<script>
import API from '@/api'
import EChart from '@/demo-components/chart/echart'
import Material from 'vuetify/es5/util/colors'
import BoxChart from '@/demo-components/chart/echart/BoxChart'
import ProfileCard from '@/demo-components/card/ProfileCard'
import WeatherCard from '@/demo-components/card/WeatherCard'
import MiniStatisticCard from '@/demo-components/card/MiniStatisticCard'
import CircleStatisticCard from '@/demo-components/card/CircleStatisticCard'
import LinearStatisticCard from '@/demo-components/card/LinearStatisticCard'
export default {
  name: 'PageDashboard',
  components: {
    ProfileCard,
