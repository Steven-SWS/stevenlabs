...
<script>
import VG2Column from '@/demo-components/chart/g2plot/column'
import VG2Line from '@/demo-components/chart/g2plot/line'
import VG2Gauge from '@/demo-components/chart/g2plot/gauge'
import VG2Donut from '@/demo-components/chart/g2plot/donut'
import VG2Cloud from '@/demo-components/chart/g2plot/cloud'
import VG2Bullet from '@/demo-components/chart/g2plot/bullet'
export default {
  name: 'PageChartG2',
  components: {
    VG2Column,
